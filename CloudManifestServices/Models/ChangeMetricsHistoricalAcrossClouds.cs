...
{
    [Table("Change_Metrics_Historical_ACROSS_Clouds")]
    [Index("Cloud", "ResourceProviderTypeTotal", "MetricTotal", "ProcessDate", Name = "Idx_Change_Metrics_Historical_ACROSS_Clouds")]
    public partial class ChangeMetricsHistoricalAcrossClouds
    {
        [Key]
        [StringLength(50)]
