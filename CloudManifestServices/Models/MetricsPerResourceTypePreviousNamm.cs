...
{
    [Keyless]
    [Table("MetricsPerResourceType_Previous_NAMM")]
    [Index("Cloud", "ResourceProviderType", Name = "Idx_MetricsPerResourceType_Previous_NAMM")]
    public partial class MetricsPerResourceTypePreviousNamm
    {
        [Required]
        [StringLength(50)]
